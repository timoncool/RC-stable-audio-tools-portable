...
REM Папка для генераций
set "OUTPUT_DIR=%SCRIPT_DIR%generations"
...
echo.
echo После запуска приложение откроется в браузере автоматически.
echo.
...
if errorlevel 1 (
    ...
    echo 2. Недостаточно памяти GPU/RAM (нужно минимум 6GB VRAM)
